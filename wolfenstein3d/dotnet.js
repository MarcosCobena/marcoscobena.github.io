...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 701328,
    DYNAMIC_BASE = 5944208,
    DYNAMICTOP_PTR = 701168;
...
var ASM_CONSTS = {
  568760: function() {return STACK_MAX;},  
 568782: function() {return TOTAL_STACK;},  
 642458: function($0, $1) {MONO.string_decoder.decode($0, $0 + $1, true);},  
 642737: function($0, $1, $2) {var str = MONO.string_decoder.decode ($0, $0 + $1); try { var res = eval (str); if (res === null || res == undefined) return 0; res = res.toString (); setValue ($2, 0, "i32"); } catch (e) { res = e.toString (); setValue ($2, 1, "i32"); if (res === null || res === undefined) res = "unknown exception"; } var buff = Module._malloc((res.length + 1) * 2); stringToUTF16 (res, buff, (res.length + 1) * 2); return buff;},  
 643156: function() {var err = new Error(); console.log ("Stacktrace: \n"); console.log (err.stack);}
};
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 701232, 4), 701232);function _gmtime_r(time, tmPtr) {
  ...
  var MONO={pump_count:0,timeout_queue:[],mono_wasm_runtime_is_ready:false,mono_wasm_ignore_pdb_load_errors:true,pump_message:function () {
  		...
  		},string_decoder:{copy:function (mono_string) {
  				if (mono_string == 0)
  					return null;
