...
addPost("Thu 5: Analysing an app written by others", "Thu-5--Analysing-an-app-written-by-others-ab9c50246d5a", "05/04/2018");
addPost("Wed 4: Meetings", "Wed-4--Meetings-2556117737e8", "04/04/2018");
addPost("Tue 3: Multiple instances of the same ViewModel", "Tue-3--Multiple-instances-of-the-same-ViewModel-5e696e8dd793", "03/04/2018");
addPost("Mon 2: Polly’s Retry policy to make network calls", "Mon-2--Polly-s-Retry-policy-to-make-network-calls-224d70957b2c", "02/04/2018");
addPost("Wed 28: One approach to Visual States", "Wed-28--One-approach-to-Visual-States-730813111718", "28/03/2018");
addPost("Tips &amp; tricks to rely in VirtualBox", "Tips---tricks-to-rely-in-VirtualBox-e9e28c8cd180", "23/03/2018");
addPost("Thu, 22: Charles with Android, VirtualBox’ HD size &amp; UWP debugging", "Thu--22--Charles-with-Android--VirtualBox--HD-size---UWP-debugging-284998a21a5e", "22/03/2018");
addPost("Wed, 21: Xamarin Inspector for Forms &amp; NamedSizes", "Wed--21--Xamarin-Inspector-for-Forms---NamedSizes-fea033823240", "21/03/2018");
addPost("Tuesday, 20/3/2018", "Tuesday--20-3-2018-f42e8eb10d25", "20/03/2018");
addPost("Playing with Xamarin.Forms for Web", "Playing-with-Xamarin-Forms-for-Web-cde48f1e12b4", "19/03/2018");
...
addPost("Lottie, scroll’s headers and GradientBoxView #XamarinForms", "Lottie--scroll-s-headers-and-GradientBoxView--XamarinForms-2e0afb12a4a", "06/12/2017");
...
addPost("Just-PCL OpenID authentication in #XamarinForms, Firebase and limited resources", "Just-PCL-OpenID-authentication-in--XamarinForms--Firebase-and-limited-resources-53591bb20887", "08/11/2017");
...
addPost("The #Android’s FAB which liked to follow BottomBar #Xamarin", "The--Android-s-FAB-which-liked-to-follow-BottomBar--Xamarin-57a805f646", "04/10/2017");
addPost("The refreshes bug and i18n", "The-refreshes-bug-and-i18n-3d9ad2a9421b", "25/09/2017");
...
addPost("Hacia la e-Tauromaquia. Una propuesta para la convivencia y el emprendimiento", "Hacia-la-e-Tauromaquia--Una-propuesta-para-la-convivencia-y-el-emprendimiento-fe84192e75c4", "15/08/2016");
